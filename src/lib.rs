...
//! ***version: 1.4.4 date: 2024-03-02 author: [Bestia.dev](https://bestia.dev) repository: [GitHub](https://github.com/bestia-dev/cargo_auto_lib)***
//!
...
//! [![Lines in Doc comments](https://img.shields.io/badge/Lines_in_Doc_comments-927-blue.svg)](https://github.com/bestia-dev/cargo_auto_lib/)
