...
pub fn auto_doc_tidy_html() -> Result<()> {
    ...
    crate::run_shell_command_static("tidy xxx 2> docs/tidy_warnings.txt")?;
    // Check if it contains `command not found`
    let text = std::fs::read_to_string("docs/tidy_warnings.txt")?;
    // don't need this file anymore
    crate::run_shell_command_static("rm -f docs/tidy_warnings.txt")?;
    if !text.contains("command not found") {
        ...
        crate::run_shell_command_static(
