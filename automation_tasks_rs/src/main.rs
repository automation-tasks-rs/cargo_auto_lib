...
fn task_build() {
    ...
    println!(
        r#"
  {YELLOW}After `cargo auto build`, examples and tests{RESET}
...
fn task_release() {
    ...
    println!(
        r#"
  {YELLOW}After `cargo auto release`, run examples and tests{RESET}
  {YELLOW}if {package_name} ok then{RESET}
...
fn task_publish_to_crates_io() {
    let _tag_name_version = crate::build_lib_mod::task_publish_to_crates_io();
